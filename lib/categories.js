...
export const CATEGORY_SEO = {
  ...
  'smm': {
    ...
    dbCategory: 'SMM',
    emoji: '📱',
    description: 'SMM заказы: ведение соцсетей, оформление, постинг, контент-план. Свежие проекты для SMM-фрилансеров и таргетологов со всех бирж в одной ленте.',
    keywords: 'smm заказ, смм заказ, SMM фриланс, смм фрилансер, смм фриланс, ведение соцсетей заказы, постинг удалённо, оформление инстаграм',
  },
  'parsing': {
    name: 'Парсинг',
    dbCategory: 'Парсинг',
    emoji: '🤖',
    description: 'Парсинг сайтов на заказ: сбор данных, разработку ботов, скрипты автоматизации. Заказы на парсинг фриланс со всех бирж в одной ленте.',
    keywords: 'парсинг сайтов фриланс, парсинг на заказ, заказать парсинг, парсинг фриланс, бот заказы, скрипт автоматизация, сбор данных удалённо',
  },
  'verstka': {
    name: 'Вёрстка',
    dbCategory: 'Вёрстка',
    emoji: '📄',
    description: 'Верстка заказы: HTML, CSS, адаптивная и кроссбраузерная вёрстка, натяжка на CMS. Свежие заказы на вёрстку сайтов фриланс со всех бирж.',
    keywords: 'верстка заказы, вёрстка сайтов фриланс, верстка фриланс, фриланс верстка, HTML CSS заказы, адаптивная верстка удалённо',
  },
  'frontend': {
    name: 'FrontEnd',
    dbCategory: 'FrontEnd',
    emoji: '⚛️',
    description: 'Фронтенд заказы: React, Vue, Angular, Next.js, TypeScript. Свежие проекты на фриланс фронтенд со всех бирж в одной ленте.',
    keywords: 'фронтенд заказы, frontend фриланс, фриланс фронтенд, React заказы, Vue Angular удалённо, JavaScript разработка',
  },
  'backend': {
    name: 'BackEnd',
    dbCategory: 'BackEnd',
