...
export const ROLE_SEO = {
  ...
  videomaker: {
    ...
    label: 'Видеомонтажёр',
    emoji: '🎬',
    h1: 'Заказы на видеомонтаж и монтаж видео — фриланс',
    metaTitle: 'Заказы на видеомонтаж и монтаж видео — фриланс работа | FreelanceHere',
    metaDescription: 'Где брать заказы на монтаж видео: свежие проекты по видеомонтажу с FL.ru, Kwork, Youdo и других бирж в одной ленте. Premiere Pro, DaVinci, After Effects, Reels, motion-design.',
    keywords: 'видеомонтаж фриланс, заказы на видеомонтаж, монтаж видео заказы, заказы на монтаж видео, видеомонтажер фриланс, где брать заказы на монтаж видео, фриланс видеомонтаж, premiere pro удалённо, after effects заказ, монтаж reels',
    heroText: 'Все заказы на монтаж видео и видеомонтаж в одной ленте: ролики для YouTube и соцсетей, Reels, моушн-графика, цветокор, обработка.',
    perks: [
